...
def generate_model(dataset, run):
    ...
    run.log_confusion_matrix('Employee Retention Confusion Matrix', cf_matrix_json,
                             description='Confusion matrix generated for the run')
...
def main():
    ...
    parser.add_argument('--clean_data_folder', dest='clean_data_folder',
            type=str, help='folder path that stores the clean data file')
    parser.add_argument('--new_model_folder', dest='new_model_folder',
            type=str, help='output folder path that stores the new model .pkl file name')
    ...
    parser.add_argument('--new_model_file', dest='new_model_file',
            type=str, help='name of the new model .pkl file')
