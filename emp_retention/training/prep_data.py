...
def main():
    ...
    parser.add_argument('--raw_data_file', dest='raw_data_file', type=str, help='input raw data in .csv file')
    parser.add_argument('--clean_data_folder', dest='clean_data_folder', type=str, help='output folder path that stores the clean data file')
    ...
    run.log('Output path of clean data', args.clean_data_folder + args.clean_data_file)
